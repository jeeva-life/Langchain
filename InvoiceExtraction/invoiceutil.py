...
def create_docs(user_pdf_list):
    ...
    for filename in user_pdf_list:
        ...
        {{'Invoice no.': 'xxxxxxx','Description': 'xxxxxx','Quantity': 'x','Date': 'dd/mm/yyyy',
        'Unit price': 'xxx.xx','Amount': 'xxx.xx','Total': 'xxx.xx','Email': 'xxx@xxx.xxx','Phone number': 'xxxxxxxxxx','Address': 'xxxxxxxx'}}
